...
public class ExplorerActivityTopCitiesListAdapter extends ArrayAdapter<City>
{
    private ArrayList<City> cities;
    Context context;
    int resource;
    int tvResourceId;
    public ExplorerActivityTopCitiesListAdapter(Context context, int resource, int textViewResourceId, ArrayList<City> objects) {
